...
class LoginPage(BasePage):
    ...
    def check_correct_url(self) -> bool:
        """
        Проверяет, что текущий URL совпадает с ожидаемым URL страницы логина.
    ...
    def send_email_to_email_field(self, email: str) -> None:
        """
        Вводит указанный email в поле ввода электронной почты.
    ...
    def send_password_to_password_field(self, password: str) -> None:
        """
        Вводит указанный пароль в поле ввода пароля.
